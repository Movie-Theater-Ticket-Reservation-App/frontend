...
export const Autoplay = () => {
  ...
  const handleBookClick = (movieTitle) => {
    navigate(`/search?query=${encodeURIComponent(movieTitle)}`); // Navigate to the search page with the movie title
  };
          ...
          >
            ...
            <Box direction="row" gap="small">
              <Button
                ...
                onClick={() => handleBookClick("The Great Gatsby")} // Pass the movie title
              />
              <Button
                secondary
                label="More Info"
          ...
          >
            ...
            <Box direction="row" gap="small">
              <Button
                ...
                onClick={() => handleBookClick("Cars")} // Pass the movie title
              />
              <Button
                secondary
                label="More Info"
          ...
          >
            ...
            <Box direction="row" gap="small">
              <Button
                ...
                onClick={() => handleBookClick("Wall-E")} // Pass the movie title
              />
              <Button
                secondary
                label="More Info"
