...
export const Autoplay = () => {
  ...
  const handleBookClick = (movieTitle) => {
    const query = encodeURIComponent(movieTitle);
    navigate(`/search?query=${query}`); // Redirect to the search page with the movie title
  };
          ...
          >
            ...
            <Box direction="row" gap="small">
              <Button
                ...
                label="Book"
                color="brand"
                onClick={() => handleBookClick("The Wild Robot")} // Pass movie title to handler
                style={{
                  borderRadius: "4px",
                  padding: "10px 20px",
                  fontSize: "16px",
          ...
          >
            ...
            <Box direction="row" gap="small">
              <Button
                ...
                label="Book"
                color="brand"
                onClick={() => handleBookClick("Gladiator II")} // Pass movie title to handler
                style={{
                  borderRadius: "4px",
                  padding: "10px 20px",
                  fontSize: "16px",
          ...
          >
            ...
            <Box direction="row" gap="small">
              <Button
                ...
                label="Book"
                color="brand"
                onClick={() => handleBookClick("Venom: The Last Dance")} // Pass movie title to handler
                style={{
                  borderRadius: "4px",
                  padding: "10px 20px",
                  fontSize: "16px",
